...
// Return the JSX
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img
        alt="ecommerce"
        className="lg:w-1/3 w-full lg:h-auto h-48 object-cover object-center rounded"
        src={res.image}
      />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            <span className="text-gray-600 ml-3">{res.rating.rate} Rate</span>
          </span>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-white-900">
            ${res.price}
          </span>
